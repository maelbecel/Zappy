...
namespace UI {
    ...
    TileHUD::TileHUD() : _background(sf::Vector2f(Window::getWindowWidth(), Window::getWindowHeight()))
    {
        ...
        try {
            std::shared_ptr<sf::Texture> texture = TextureManager::getTexture(UI::TILEHUD);
        ...
        _changePlayerRightButton = std::make_shared<Button>(changePlayerRightButton);
        _changeEggLeftButton = std::make_shared<Button>(changeEggLeftButton);
        _changeEggRightButton = std::make_shared<Button>(changeEggRightButton);
        ...
        try {
            _tileResourceSprite = {
                {FOOD, {sf::Text(), sf::Sprite(*TextureManager::getTexture(UI::R_FOOD))}},
                {LINEMATE, {sf::Text(), sf::Sprite(*TextureManager::getTexture(UI::R_LINEMATE))}},
                {DERAUMERE, {sf::Text(), sf::Sprite(*TextureManager::getTexture(UI::R_DERAUMERE))}},
                {SIBUR, {sf::Text(), sf::Sprite(*TextureManager::getTexture(UI::R_SIBUR))}},
                {MENDIANE, {sf::Text(), sf::Sprite(*TextureManager::getTexture(UI::R_MENDIANE))}},
                {PHIRAS, {sf::Text(), sf::Sprite(*TextureManager::getTexture(UI::R_PHIRAS))}},
                {THYSTAME, {sf::Text(), sf::Sprite(*TextureManager::getTexture(UI::R_THYSTAME))}}
            };
        } catch (const Error::TextureError &e) {
