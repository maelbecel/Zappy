...
namespace UI {
    HelpHUD::HelpHUD(): _background(sf::Vector2f(Window::getWindowWidth(), Window::getWindowHeight()))
    {
        ...
        ArrowButtonWidget *leftButton = new ArrowButtonWidget(sf::Vector2f(leftButtonXPosition, leftButtonYPosition), sf::Vector2f(16 * 2 * backgroundSpriteScale, 16 * 2 * backgroundSpriteScale), ArrowDirection::LEFT);
        ArrowButtonWidget *rightButton = new ArrowButtonWidget(sf::Vector2f(rightButtonXPosition, rightButtonYPosition), sf::Vector2f(16 * 2 * backgroundSpriteScale, 16 * 2 * backgroundSpriteScale), ArrowDirection::RIGHT);
