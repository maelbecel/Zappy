...
namespace UI {
    ...
    Asteroid::Asteroid(const sf::Vector2f &position, const sf::Vector2f &movement, int size) : _position (position), _movement(movement), _size(size)
    {
        _angle = Math::random(360);
    }
    ...
    void Asteroid::draw(sf::RenderTarget &target, sf::RenderStates states) const
    {
        ...
        texture.loadFromFile(UI::ASTEROID);
    ...
    sf::Vector2f Asteroid::getMovement() const
    {
        return _movement;
    }
    ...
    void Asteroid::setMovement(const sf::Vector2f &movement)
    {
        _movement = movement;
    }
    ...
    std::vector<Asteroid> AsteroidHandler::generateAsteroids(int nbAsteroids) const
    {
    ...
    {
        static std::vector<Asteroid> _asteroids = generateAsteroids(2);
